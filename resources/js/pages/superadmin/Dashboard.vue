...
import { Users, UserCheck, UserX, Shield, Activity, Database } from 'lucide-vue-next';
        ...
        <div class="flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 dark:text-gray-400">Manage your entire application</p>
                </div>
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <div class="rounded-xl border border-sidebar-border/70 bg-white p-6 dark:border-sidebar-border dark:bg-gray-800">
                    <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-white">System Status</h3>
                    <div class="space-y-3">
                        <div class="flex items-center justify-between">
